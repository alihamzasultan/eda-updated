...
def main():
    ...
    with st.expander("AI-Chat Assistant"):
                ...
                if st.session_state.conversation:
                    ...
                    user_style = "background-color: #f4f4f4; padding: 8px; border-radius: 10px; color: black; max-width: 80%;"
                    bot_style = "background-color: #f4f4f4; padding: 8px; border-radius: 10px; color: black; max-width: 80%;"
                    ...
                    for i, chat in enumerate(conversation_reversed):
                                ...
                                user_style = "background-color: #606060; padding: 8px; border-radius: 10px; color: white; max-width: 80%;"
                                bot_style = "background-color: #606060; padding: 8px; border-radius: 10px; color: white; max-width: 80%;"
